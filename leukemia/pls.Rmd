...
Summing up the Partial Least Squares algorithm allowed to make quite an accurate prediction using only 4 most significant components calculated on the basis of over 7000 original explanatory variables.
